...
public class AutomatedCraftingInit implements ModInitializer {
	...
	public static ScreenHandlerType AUTO_CRAFTER_SCREEN_HANDLER_TYPE;
	...
	public void onInitialize() {
		...
		AUTO_CRAFTER_SCREEN_HANDLER_TYPE = ScreenHandlerRegistry.registerSimple(AutoCrafterBlock.ID, (int syncId, PlayerInventory inventory) -> new AutoCrafterGuiDescription(syncId, inventory, ScreenHandlerContext.EMPTY));
		...
		ScreenHandlerRegistry.registerSimple(AutoCrafterBlock.ID,  (syncId, inventory) -> new AutoCrafterGuiDescription(syncId, inventory, ScreenHandlerContext.EMPTY));
